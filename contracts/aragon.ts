...
import { getDeployedAddress, getOptionalMethodAddress } from '@configs';
...
export const getKernelAddress = (): Promise<string> => getOptionalMethodAddress(lidoContract, 'kernel');
export const kernelContract = new BaseContract({ getAddress: getKernelAddress }, kernelAbi, wallet) as Contract;

export const getAclAddress = (): Promise<string> => getOptionalMethodAddress(kernelContract, 'acl');
